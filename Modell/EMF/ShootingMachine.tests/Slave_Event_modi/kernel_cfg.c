...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Trigger ), TASKNAME( TASK_BT_INTERFACE_READER ), TASKNAME( BT_IMPLIZIT_SLAVE ), TASKNAME( BT_IMPLIZIT_SLAVE2 ), TASKNAME( InitHook ), TASKNAME( TASK_BT_INTERFACE_WRITER ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Trigger, (__STK_UNIT)_stack_TASK_BT_INTERFACE_READER, (__STK_UNIT)_stack_BT_IMPLIZIT_SLAVE, (__STK_UNIT)_stack_BT_IMPLIZIT_SLAVE2, (__STK_UNIT)_stack_InitHook, (__STK_UNIT)_stack_TASK_BT_INTERFACE_WRITER, };
