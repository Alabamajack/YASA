/*
 *  kernel_cfg.c
 *  Wed Jul 08 11:46:31 2015
 *  SG Version 2.00
 *  sg.exe Master_AbgabeIII.oil -os=ECC2 -I../../../../../../../../nxtOSEK/ecrobot/../toppers_osek/sg/impl_oil -template=../../../../../../../../nxtOSEK/ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType StopSensor_Task = 6;
const TaskType InitHook = 7;

extern void TASKNAME( Manager )( void );
extern void TASKNAME( Motor_Output )( void );
...
extern void TASKNAME( StopSensor_Task )( void );
extern void TASKNAME( InitHook )( void );

static __STK_UNIT _stack_Manager[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Motor_Output[__TCOUNT_STK_UNIT(512)];
...
static __STK_UNIT _stack_StopSensor_Task[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_InitHook[__TCOUNT_STK_UNIT(512)];

const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 2, TPRI_MINTASK + 7, TPRI_MINTASK + 7, TPRI_MINTASK + 9, TPRI_MINTASK + 7, TPRI_MINTASK + 5, TPRI_MINTASK + 10, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 2, TPRI_MINTASK + 7, TPRI_MINTASK + 7, TPRI_MINTASK + 9, TPRI_MINTASK + 7, TPRI_MINTASK + 5, TPRI_MINTASK + 10, };
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Manager ), TASKNAME( Motor_Output ), TASKNAME( TASK_BT_INTERFACE_READER ), TASKNAME( TASK_BT_INTERFACE_WRITER ), TASKNAME( BT_IMPLIZIT_MASTER ), TASKNAME( BT_IMPLIZIT_MASTER2 ), TASKNAME( StopSensor_Task ), TASKNAME( InitHook ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Manager, (__STK_UNIT)_stack_Motor_Output, (__STK_UNIT)_stack_TASK_BT_INTERFACE_READER, (__STK_UNIT)_stack_TASK_BT_INTERFACE_WRITER, (__STK_UNIT)_stack_BT_IMPLIZIT_MASTER, (__STK_UNIT)_stack_BT_IMPLIZIT_MASTER2, (__STK_UNIT)_stack_StopSensor_Task, (__STK_UNIT)_stack_InitHook, };
...
const CounterType C_StopSensor_Alarm = 0;
...
const AlarmType StopSensor_Alarm = 0;

DeclareTask(StopSensor_Task);
static void _activate_alarm_StopSensor_Alarm( void );
static void _activate_alarm_StopSensor_Alarm( void )
{ (void)ActivateTask( StopSensor_Task ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_StopSensor_Alarm, };
...
const EventMaskType RTE_Manager_StopSensor_GetValue_Event_In_EVENT = (1UL << 3);
const EventMaskType RTE_Output_Manager_GetValue_Receiver_In_EVENT = (1UL << 4);
const EventMaskType RTE_DisplayOutput_Manager_GetValue_Event_In_EVENT = (1UL << 5);
const EventMaskType BT_IMPLIZIT_MASTER2_EVENT = (1UL << 6);
