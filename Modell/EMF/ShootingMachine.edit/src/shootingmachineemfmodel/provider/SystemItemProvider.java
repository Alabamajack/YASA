...
/**
 * This is the item provider adapter for a {@link shootingmachineemfmodel.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShootingmachineemfmodelPackage.Literals.SYSTEM__HAS_COMPONENT);
			childrenFeatures.add(ShootingmachineemfmodelPackage.Literals.SYSTEM__HAS_BRICK);
			childrenFeatures.add(ShootingmachineemfmodelPackage.Literals.SYSTEM__HAS_CONNECTIONS);
			childrenFeatures.add(ShootingmachineemfmodelPackage.Literals.SYSTEM__HAS_INTER_BRICK_COMMUNICATION_SYSTEM);
		}
	...
	public String getText(Object object) {
		String label = ((shootingmachineemfmodel.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(shootingmachineemfmodel.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ShootingmachineemfmodelPackage.Literals.SYSTEM__HAS_COMPONENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(ShootingmachineemfmodelPackage.Literals.SYSTEM__HAS_BRICK,
				 ShootingmachineemfmodelFactory.eINSTANCE.createBrick()));

		newChildDescriptors.add
			(createChildParameter
				(ShootingmachineemfmodelPackage.Literals.SYSTEM__HAS_CONNECTIONS,
