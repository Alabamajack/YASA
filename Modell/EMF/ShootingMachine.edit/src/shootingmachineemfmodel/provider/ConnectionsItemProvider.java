...
/**
 * This is the item provider adapter for a {@link shootingmachineemfmodel.Connections} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionsItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHasReceiverPortsPropertyDescriptor(object);
			addHasSenderPortsPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Has Receiver Ports feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHasReceiverPortsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connections_hasReceiverPorts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connections_hasReceiverPorts_feature", "_UI_Connections_type"),
				 ShootingmachineemfmodelPackage.Literals.CONNECTIONS__HAS_RECEIVER_PORTS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Has Sender Ports feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHasSenderPortsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connections_hasSenderPorts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connections_hasSenderPorts_feature", "_UI_Connections_type"),
				 ShootingmachineemfmodelPackage.Literals.CONNECTIONS__HAS_SENDER_PORTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Connections)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Connections_type") :
			getString("_UI_Connections_type") + " " + label;
	}
