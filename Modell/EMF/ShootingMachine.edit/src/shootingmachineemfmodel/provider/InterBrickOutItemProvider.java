...
/**
 * This is the item provider adapter for a {@link shootingmachineemfmodel.InterBrickOut} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterBrickOutItemProvider
	 ...
	 * @generated
	 */
	public InterBrickOutItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShootingmachineemfmodelPackage.Literals.INTER_BRICK_OUT__HAS_MESSAGE_INTER_BRICK_OUT);
		}
	...
	/**
	 * This returns InterBrickOut.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InterBrickOut"));
	}
	...
	public String getText(Object object) {
		String label = ((InterBrickOut)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_InterBrickOut_type") :
			getString("_UI_InterBrickOut_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InterBrickOut.class)) {
