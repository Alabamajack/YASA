...
/**
 * This is the item provider adapter for a {@link shootingmachineemfmodel.HWPorts} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HWPortsItemProvider
	 ...
	 * @generated
	 */
	public HWPortsItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((HWPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HWPorts_type") :
			getString("_UI_HWPorts_type") + " " + label;
	}
