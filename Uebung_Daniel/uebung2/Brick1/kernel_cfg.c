...
const TaskType ReverseDir = 1;
const TaskType checkDriveButton = 2;
const TaskType checkTurnButton = 3;
...
const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 2, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 2, };
const UINT8 tinib_maxact[TNUM_TASK] = { (1) - 1, (1) - 1, (1) - 1, (1) - 1, };
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000001, 0x00000001, 0x00000000, 0x00000000, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( Main ), TASKNAME( ReverseDir ), TASKNAME( checkDriveButton ), TASKNAME( checkTurnButton ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Main, (__STK_UNIT)_stack_ReverseDir, (__STK_UNIT)_stack_checkDriveButton, (__STK_UNIT)_stack_checkTurnButton, };
